...
2023年03月26日，Yiguo Zhou 对本文件进行了修改，使得其格式符合最新山东大学（威海）本科生毕业论文要求。  
...
### 所做修改：
2023/03/26
1. 针对最新的山东大学本科毕业论文（设计）撰写规范（参考），修改了封面部分，使其符合规范要求。
2019/03/28
1. 删除了声明部分
...
## 修改者
Yiguo Zhou 
Email:zhouyiguo.private@gmail.com
...
### 2023.03.26
针对最新的山东大学本科毕业论文（设计）撰写规范（参考），修改了封面部分，使其符合规范要求。